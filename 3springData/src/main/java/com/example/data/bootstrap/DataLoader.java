...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Create HealthServices and associate them with encounters and health issues.
        ...
        // Encounter3 deliberately has no service.
        ...
        // Save HealthServices (or rely on cascade from encounters) by saving encounters.
        medicalEncounterRepository.saveAll(List.of(encounter1, encounter2, encounter3, encounter4, encounter5));
        // Alternatively, if you wish, you may also explicitly save services:
        healthServiceRepository.saveAll(List.of(service1, service2, service3, service4));
